...
/*
 * 300 seconds, matching REVALIDATE_SECONDS in src/lib/sheets.ts. This page now
 * reads the Wishlist tab to check that an item in the URL is real, so it is a
 * sheet-backed page like the others.
 */
